...
public class DebateEvents {
	...
	public DebateEvents() {
		...
		pf.addLayout(Layout.RELATED.getIndex(), "[h:0h:1][h:2h:3][h:5h:6][h:7h:8]");
		pf.addLayout(Layout.PRO_CON.getIndex(), "[h:0h:2h:5h:7][h:1h:3h:6h:8]");
		pf.addLayout(Layout.SINGLE.getIndex(), "[h:0][h:1][h:2][h:3][h:5][h:6][h:7][h:8]");
		pf.addLayout(Layout.ALL.getIndex(), "[h:0h:1h:2h:3h:5h:6h:7h:8]");
		...
		ld.addLayout(Layout.RELATED.getIndex(), "[h:0h:1][h:3h:4h:5]");
		ld.addLayout(Layout.PRO_CON.getIndex(), "[h:0h:1h:3][h:4h:5]");
		ld.addLayout(Layout.SINGLE.getIndex(), "[h:0][h:1][h:3][h:4][h:5]");
		ld.addLayout(Layout.ALL.getIndex(), "[h:0h:1h:3h:4h:5]");
		...
		policy.addLayout(Layout.RELATED.getIndex(), "[h:0h:1h:3h:4][h:5h:6h:7h:8]");
		policy.addLayout(Layout.PRO_CON.getIndex(), "[h:0h:3h:6h:8][h:1h:4h:5h:7]");
		policy.addLayout(Layout.SINGLE.getIndex(), "[h:0][h:1][h:3][h:4][h:5][h:6][h:7][h:8]");
		policy.addLayout(Layout.ALL.getIndex(), "[h:0h:1h:3h:4h:5h:6h:7h:8]");
